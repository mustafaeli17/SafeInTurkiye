...
const localized: Record<string, [string, string][]> = {
  de: [
    ['Wie erhalte ich eine İstanbulkart?', 'Verkaufs- und Aufladestellen stehen auf der offiziellen İstanbulkart-Seite. Kartenpreis und Fahrguthaben sind getrennt.'], ['Wie erhalte ich eine Verkehrskarte in Ankara?', 'Nutzen Sie EGO-Servicezentren oder autorisierte Händler. Besucher fragen nach der Karte zum Normaltarif.'], ['Wie erhalte ich eine İzmirim Kart?', 'Prüfen Sie offizielle Verkaufs- und Aufladestellen. Für İZBAN gelten besondere Abbuchungs- und Erstattungsregeln.'], ['Wie erhalte ich eine Antalyakart?', 'Kaufen und laden Sie die Karte an Automaten, Zentren oder Händlern. Kontaktlose Bankkarten werden ebenfalls unterstützt.'], ['Wo finde ich Umstiege und letzte Abfahrten?', 'Tarife und letzte Fahrten hängen von Linie und Tag ab. Prüfen Sie den offiziellen Betreiber für Ihr Reisedatum.'], ['Warum kann der Taxipreis abweichen?', 'Wartezeit, Verkehr, Umwege und Maut können den Taxameterpreis verändern. Lassen Sie sich eine Quittung geben.'], ['Ist der Referenzkurs der Wechselstubenkurs?', 'Nein. Wechselstuben haben eigene An- und Verkaufskurse. Fragen Sie vorab nach Endbetrag und Provision.'], ['Was tun, wenn mein Standort nicht gefunden wird?', 'Prüfen Sie die Browserfreigabe oder suchen Sie rund um das Stadtzentrum. Rufen Sie vor einem Besuch an.'], ['Ist eine Buchungsanfrage bestätigt?', 'Nein. Erst die Bestätigung des Betriebs macht die Buchung verbindlich.'], ['Warum muss ich mich anmelden?', 'Die Anmeldung ordnet Anfragen Ihrem Konto zu. Eine nicht verbundene Vorschau kann keine Anfrage speichern.'], ['Sind Orte in der Nähe jetzt geöffnet?', 'Angezeigt werden veröffentlichte Zeiten. Feiertage können abweichen; rufen Sie vorher an.'], ['Wie wähle ich Sehenswürdigkeiten?', 'Bündeln Sie nahe Orte für einen Tag und prüfen Sie Öffnungszeiten, Tickets und Barrierefreiheit.'], ['Fliegen Ballons in Kappadokien täglich?', 'Flüge hängen von Wetter und Freigabe ab. Fragen Sie den gebuchten Anbieter.'], ['Garantieren Fotos und Preise Verfügbarkeit?', 'Nein. Bestätigen Sie Verfügbarkeit und Endpreis direkt beim Betrieb.'],
  ],
  fr: [
    ['Comment obtenir une İstanbulkart ?', 'Consultez les points de vente et de recharge officiels. Le prix de la carte et le solde de voyage sont distincts.'], ['Comment obtenir une carte de transport à Ankara ?', 'Utilisez les centres EGO ou les revendeurs agréés et demandez une carte plein tarif pour visiteur.'], ['Comment obtenir une İzmirim Kart ?', 'Consultez les points officiels. Vérifiez les règles de débit et de remboursement pour İZBAN.'], ['Comment obtenir une Antalyakart ?', 'Achetez et rechargez la carte aux automates, centres ou revendeurs. Les cartes bancaires sans contact sont aussi acceptées.'], ['Comment vérifier les correspondances et le dernier départ ?', 'Tarifs et derniers départs varient selon la ligne et le jour. Consultez l’opérateur officiel.'], ['Pourquoi l’estimation taxi peut-elle différer ?', 'Attente, circulation, détour et péages changent le total. Demandez un reçu.'], ['Le taux de référence est-il celui du bureau ?', 'Non. Chaque bureau fixe ses cours d’achat et de vente. Demandez le montant net et la commission.'], ['Que faire si ma position est introuvable ?', 'Vérifiez l’autorisation du navigateur ou cherchez autour du centre-ville. Appelez avant de partir.'], ['Une demande de réservation est-elle confirmée ?', 'Non. Attendez la confirmation de l’établissement.'], ['Pourquoi dois-je me connecter ?', 'La connexion associe la demande à votre compte. Un aperçu non connecté ne peut pas l’enregistrer.'], ['Les lieux proches sont-ils ouverts maintenant ?', 'Nous affichons les horaires publiés. Ils peuvent changer les jours fériés ; appelez avant de vous déplacer.'], ['Comment choisir les lieux à visiter ?', 'Regroupez les lieux proches et vérifiez horaires, billets et accessibilité officiels.'], ['Les montgolfières de Cappadoce volent-elles chaque jour ?', 'Les vols dépendent de la météo et de l’autorisation. Vérifiez auprès de l’opérateur réservé.'], ['Photos et prix garantissent-ils la disponibilité ?', 'Non. Confirmez la disponibilité et le prix final auprès de l’établissement.'],
  ],
  ru: [
    ['Как купить İstanbulkart?', 'Официальные точки продажи и пополнения указаны на сайте İstanbulkart. Стоимость карты и баланс поездок считаются отдельно.'], ['Как купить транспортную карту в Анкаре?', 'Обратитесь в центры EGO или к авторизованным продавцам и попросите полную карту для посетителя.'], ['Как купить İzmirim Kart?', 'Проверьте официальные точки продажи. Перед İZBAN уточните правила списания и возврата.'], ['Как купить Antalyakart?', 'Карту продают и пополняют в автоматах, центрах и у дилеров. Поддерживаются и бесконтактные банковские карты.'], ['Где узнать пересадки и последний рейс?', 'Тариф и последний рейс зависят от линии и дня. Проверяйте официальный сайт оператора.'], ['Почему цена такси может отличаться?', 'Ожидание, пробки, объезд и платные дороги меняют итог. Попросите чек.'], ['Справочный курс равен курсу обменника?', 'Нет. Обменник устанавливает отдельные курсы покупки и продажи. Уточните комиссию и итоговую сумму.'], ['Что делать, если геолокация не работает?', 'Проверьте разрешение браузера или ищите около центра города. Позвоните перед визитом.'], ['Заявка на бронь уже подтверждена?', 'Нет. Дождитесь подтверждения от заведения.'], ['Зачем входить в аккаунт?', 'Вход связывает заявку с аккаунтом. Неподключённый предпросмотр не может сохранить её.'], ['Открыты ли места рядом сейчас?', 'Показаны опубликованные часы. В праздники они могут меняться; позвоните заранее.'], ['Как выбрать места для посещения?', 'Объедините близкие места в один день и проверьте часы, билеты и доступность.'], ['Шары в Каппадокии летают ежедневно?', 'Полёты зависят от погоды и разрешения. Уточните у забронированного оператора.'], ['Фото и цены гарантируют наличие?', 'Нет. Подтвердите наличие и итоговую цену напрямую.'],
  ],
  zh: [
...
const ui: Record<string, string[]> = {
  ...
  de: ['Praktische Hinweise zu Verkehr, Geld, Standort und Buchungen.', 'Fragen durchsuchen…', 'Offizielle Informationen', 'Keine passende Frage gefunden.'],
  fr: ['Conseils pratiques sur les transports, l’argent, la localisation et les réservations.', 'Rechercher une question…', 'Informations officielles', 'Aucune question correspondante.'],
  ru: ['Практические советы о транспорте, деньгах, геолокации и бронировании.', 'Поиск по вопросам…', 'Официальная информация', 'Подходящих вопросов нет.'],
};
